...
**OG image:** `npm run generate:og` → [images/og-default-v4.png](images/og-default-v4.png) (copy from `config/sot.json` → `marketing.seo.ogImage`; bump filename in [scripts/build-locale-pages.js](scripts/build-locale-pages.js) `OG_IMAGE_REL` when busting social caches)
